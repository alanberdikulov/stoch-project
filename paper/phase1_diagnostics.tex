...
empirical-moment estimator on standardised returns. Both norms are \emph{finite for every
...
Bernstein regime: any concentration argument we deploy (e.g., for max-norm of $\hat\mu$ or
...
For the empirical covariance with $n/T=0.186$ the Marchenko-Pastur edges (under iid
...
support one wants $\hat\Sigma$ to satisfy a Restricted Isometry Property (RIP). The
